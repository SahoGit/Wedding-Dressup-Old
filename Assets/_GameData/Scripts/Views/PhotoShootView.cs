...
//public class PhotoShootView : MonoBehaviour {
...
//	public RectTransform bgbuttonStartpoint,bgbuttonEndPoint;
...
//		MoveAction (Background_Button, bgbuttonEndPoint, 1.0f, iTween.EaseType.easeInOutBounce);
...
//	}
//	private void lightsMovement()
//	{			
//		RotateActionloop (light1, -20.0f, 2.0f, iTween.EaseType.linear, iTween.LoopType.pingPong);
//		RotateActionloop (light2, 20.0f, 2.0f, iTween.EaseType.linear, iTween.LoopType.pingPong);
//	}
//	#endregion
...
//	{
//	//Background_Button.SetActive (false);
//		light1.SetActive(false);
//		light2.SetActive (false);
//	CharacterEyes.gameObject.SetActive(false);
//	MoveAction (Background_Button, bgbuttonStartpoint,0.1f, iTween.EaseType.easeInOutBounce);
//	PhotoFrame.SetActive (true);
//		ScaleAction (PhotoFrame, 0.95f,0.5f, iTween.EaseType.easeInBounce);
//	Invoke ("screenShot",0.5f);
//	}
//	private void screenShot()
//	{
//		ScaleAction(PhotoFrame, 1.0f,0.2f,iTween.EaseType.easeInBounce);
//		Invoke ("RestarButtonAppear",1.0f);
//	}
//	private void RestarButtonAppear()
//	{
...
//	{
//		SoundManager.instance.PlayButtonClickSound ();
//		NavigationManager.instance.ReplaceScene (GameScene.CHARACTERSELECTION);
...
//		#if UNITY_ANDROID
//		Application.OpenURL ("https://play.google.com/store/apps/developer?id=Salon+Makeover+Games");
//		#endif
//		#if UNITY_IOS
//		Application.OpenURL ("https://itunes.apple.com/us/developer/mohsin-waqar/id941100457");
//		#endif
