...
//////////////////////////////////////////////////////////////////////////////
        ...
        public Drawable_DrawingColor[] otherDrawables;
        private void OnMouseDown()
        {
            for (int i = 0; i < otherDrawables.Length; i++)
            {
                otherDrawables[i].enabled = false;
            }
        }
        ...
        public void MarkPixelToChange(int x, int y, Color color)
        {
            ...
            if (cur_colors[array_pos].a < 0.5 )
            {
                return;
            }

            if (cur_colors[array_pos].r<50)
            {
                if (cur_colors[array_pos].r == cur_colors[array_pos].g)
                {
                    if (cur_colors[array_pos].g == cur_colors[array_pos].b)
                    {
                        return;
                    }
                }
        ...
        IEnumerator GetPixel()
        {
            ...
            if (isColor)
            {
                totalNumOfPixels = drawableImageColorsArray.Where(color => color.a != 0).Count();
            }
            else
            {
        ...
        void Awake()
        {
            ...
            fill_colours_array = new Color[(int)drawable_sprite.rect.width * (int)drawable_sprite.rect.height];
